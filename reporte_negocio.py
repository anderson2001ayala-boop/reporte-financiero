...
ax1 = axes[0, 0]
ax1.bar(dias, ventas, color=colores, edgecolor='none', width=0.6)
...
ax3 = axes[1, 0]
ax3.bar(['Ventas','Gastos','Ganancia'], [ventas_totales, gastos_totales, ganancia_neta],
        color=['#00c48c','#ff6b6b','#ffd166'], width=0.5, edgecolor='none')
